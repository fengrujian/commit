...
public interface MemberService {
	...
	int insertmember(String name,Long username, String password1);
	...
	String getpassword(Long username);

	Member getPhoneById(Long memberId);

	List<MemberDto> searchByPage(MemberDto memberDto);
