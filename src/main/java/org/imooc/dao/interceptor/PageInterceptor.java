...
public class PageInterceptor implements Interceptor{
	...
	public Object intercept(Invocation arg0) throws Throwable {
		...
		String id = mappedStatement.getId();//Statement��id
		if(id.endsWith("ByPage")) {
			BoundSql boundSql = statementHandler.getBoundSql();
			String sql = boundSql.getSql();//���mybatis��sql�ļ�����ص�sql���
			String countSql = "select count(*) from(" + sql + ")t";//��ø���
			...
			if(rs.next()) {
				page.setTotalNumber(rs.getInt(1));//总条数
			}
