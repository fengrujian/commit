...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body style="background: #FFFFFF;">
		<form action="${basePath}/businesses/search" id="mainForm" method="">
			...
			<table class="table" cellspacing="0" cellpadding="0" width="100%" align="center" border="0">
				...
				<c:if test="${!empty list}">
					...
					<tr>
						...
						<td>${item.businesser.name}</td>
						<td>${item.businesser.user.name}</td>
						<td>${item.businesser.user.chName}</td>
						<td>${item.businesser.user.group.name}</td>
						<td>
