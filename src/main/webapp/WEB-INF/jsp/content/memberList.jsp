...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript" src="${basePath}/js/content/memberList.js"></script>
	</head>
	<body style="background: #FFFFFF;">
		<form action="${basePath}/member/search" id="mainForm" method="post">
			...
			<div class="ui_content">
			    ...
			    <div id="box_border">
				<div id="box_top">搜索&nbsp;&nbsp;&nbsp;&nbsp;会员列表</div>
				<div id="box_bottom">
				   <table class="tab1">
					<tbody>
						<tr>
							<td align="right" width="80">会员昵称：</td>
							<td>								
