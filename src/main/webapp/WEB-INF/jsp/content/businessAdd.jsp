...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body style="background: #FFFFFF;">
		<form id="mainForm" method="post" action="${basePath}/businesses/${modifyObj.id}" enctype="multipart/form-data">
		    ...
		    <input name="businesserId" id="businesserId" value="${searchParam.id}" type="hidden"/>
			...
			<div class="right">
				<div class="current">当前位置：<a href="###">商家管理</a> &gt; 新增商品</div>
				<div class="rightCont">
<!-- 					<p class="g_title fix">新增商品</p> -->
...
<%-- 											<c:if test="${item.code == modifyObj.city}"> --%>
<!-- 											    selected="selected" -->
<%-- 											</c:if> --%>
