...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript" src="${basePath}/js/content/dicList.js"></script>
	</head>
	<body style="background: #FFFFFF;">
		<form action="${basePath}/dic/search" id="mainForm" method="post">
