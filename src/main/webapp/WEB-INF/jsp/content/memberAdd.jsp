...
<html xmlns="http://www.w3.org/1999/xhtml"><head>
		...
		<script type="text/javascript" src="${basePath}/js/content/memberAdd.js"></script>
	</head>
	<body style="background: #FFFFFF;">
		<form id="mainForm" method="post" action="${basePath}/member/add" enctype="multipart/form-data">
			<input type="hidden" id="message" value="${pageCode.msg}"/>
			<input type="hidden" id="basePath" value="${basePath}"/>
			<input name="currentPage" id="currentPage" value="${searchParam.page.currentPage}${adDto.page.currentPage}" class="allInput" type="hidden"/>
			<input name="name_like" id="name_like" value="${searchParam.name}${adDto.name}" class="allInput" type="hidden"/>
			<div class="right">
				<div class="current">当前位置：<a href="###">会员信息</a> &gt;会员添加</div>
				<div class="rightCont">
