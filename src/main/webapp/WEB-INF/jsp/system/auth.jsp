...
<!--                 <li class="rMenuLi disabled" onmousemove="move(this);" onclick="removeUser();">删除</li> -->
        ...
        <table border="0" style="height:550px" align="left" width="99%">
           <!-- 三颗树 -->
            <tr>
            ...
            <tr>
                <td></td>
                <td align="right"><input type="button" class="tabSub1" value="分配用户组" onclick="assignGroup();"/></td>
                <td align="right"><input type="button" class="tabSub2" value="分配菜单" onclick="assignMenu();"/></td>
            </tr>
        </table>
    </body>
</html>